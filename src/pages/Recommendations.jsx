      ...
      <div className="flex flex-col md:flex-row h-screen bg-white">
        ...
        <div className="w-full md:w-1/4 md:max-w-xs h-auto md:h-full bg-gray-50 border-b md:border-b-0 md:border-r border-gray-200 flex flex-col">
            <div className="p-4 border-b">
                ...
                <p className="mt-1 text-xs text-gray-500">Optional analysis on top of saved records and fields.</p>
            </div>
            <div className="p-4">
          ...
          <div className="flex flex-col gap-4 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-sm text-green-800 md:text-base">
                  Secondary analysis for saved evidence — {soilTest?.field_name}
                </p>
              </div>
            </div>
