...
function mapNormalizedRecordToSoilTest(record) {
  ...
  return {
    ...
    linkedFieldId: record.linkedFieldId ?? null,
    linkedFieldName: record.linkedFieldName ?? null,
    enteredFieldLabel: record.enteredFieldLabel ?? null,
    extractionArtifactKey: record.extractionArtifactKey ?? null,
    reviewedArtifactKey: record.reviewedArtifactKey ?? null,
    normalizedArtifactKey: record.normalizedArtifactKey ?? null,
